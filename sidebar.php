    ...
    <div data-simplebar="" class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                	<div class="card bg-secondary border-secondary text-white-50" style="margin:2px;">
                        <div class="card-body">
                            <h5 class="mb-4 text-white"><i class="uil uil-dollar-alt me-3"></i> Créditos</h5>
                            <p class="card-text">R$ <? echo number_format($saldox, 2, ',', '');?></p>
                        </div><!-- end card-body -->
                    </div>
                </li>
                <li>
                ...
                <? if ($departamentox=='DIRETORIA'){ ?>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu" aria-expanded="true">
                          <li>
                              <li><a href="painel.php?go=usuario_adc">Novo</a></li>
                              <li><a href="painel.php?go=usuario_list">Consultar</a></li>
                          </li>

                      </ul>
                    </li>
                    <li>
                        <a href="painel.php?go=config">
                            <i class="uil-cog"></i>
