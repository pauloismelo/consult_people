                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                                        ...
                                        <div class="col-6">
                                            <div class="card border border-light">
                                                <div class="card-header bg-info border-light">
                                                    <h5 class="my-0 text-white"><i class="fas fa-users"></i> Relacionamentos</h5>
                                                </div><!-- end card-header -->
                                                <div class="card-body">
                                                    <p class="card-text text-dark">Nenhum registro encontrado!</p>
                                                </div><!-- end card-body -->
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="card border border-light">
                                                <div class="card-header bg-info border-light">
                                                    <h5 class="my-0 text-white"><i class="fas fa-phone-alt"></i> Histórico de telefones</h5>
                                                </div><!-- end card-header -->
                                                <div class="card-body">
                                                    <p class="card-text text-dark">Nenhum registro encontrado!</p>
                                                </div><!-- end card-body -->
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body text-muted">
                                <p class="mb-0">
                                    ...
                                    <div class="row mt-4">
                                        <div class="card bg-info border-white text-white-50">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-6">
                                            <div class="card border border-light">
                                                <div class="card-header bg-success border-light">
                                                    <h5 class="my-0 text-white"> Estimativa de Renda mensal<br>   
                                                </h5>
                                                </div><!-- end card-header -->
                                                <div class="card-body">
                                        ...
                                        <div class="col-6">
                                            <div class="card border border-light">
                                                <div class="card-header bg-success border-light">
                                                    <h5 class="my-0 text-white"> Estimativa de patrimônio<br>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-6">
                                            <div class="card border border-light">
                                                <div class="card-header bg-danger border-light">
                                                    <h5 class="my-0 text-white"> Dívidas Vencidas<br>   
                                                </h5>
                                                </div><!-- end card-header -->
                                                <div class="card-body">
                                        ...
                                        <div class="col-6">
                                            <div class="card border border-light">
                                                <div class="card-header bg-danger border-light">
                                                    <h5 class="my-0 text-white"> Protestos<br>   
                                                </h5>
                                                </div><!-- end card-header -->
                                                <div class="card-body">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-6">
                                            <div class="card border border-light">
                                                <div class="card-header bg-danger border-light">
                                                    <h5 class="my-0 text-white"> Cheques Sem fundos<br> 
                                                </h5>
                                                </div><!-- end card-header -->
                                                <div class="card-body">
                                                    <h5 class="card-title">
                                        ...
                                        <div class="col-6">
                                            <div class="card border border-light">
                                                <div class="card-header bg-danger border-light">
                                                    <h5 class="my-0 text-white"> Cheques Sustados<br>
                    ...
                    <div class="accordion-item bg-primary">
                        ...
                        <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body text-white text-center">Nenhum registro encontrado!
                            </div>
                        </div>
